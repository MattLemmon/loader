...
class Splash < Chingu::GameState
  def setup    
    Circle.destroy_all
    Box.destroy_all
    self.input = {:left => :decrease_speed, :right => :increase_speed, :up => :increase_size, :down => :decrease_size, :holding_space => :new_circle, :p => Pause }
